...
items.push(async ({ dir }) => {
    ...
    if (!/-webkit-overflow-scrolling:\s*auto!important/.test(cssContents.join(''))) {
        console.error('CSS should contain "* { -webkit-overflow-scrolling: auto!important }" to disable overflow scrolling on iOS.');
    }
});
